      ...
      <div class="mys">
        <ul class="info-box_s">
          ...
          <li @click="$web2app('phone',{number: customPhone})">
            <img src="./index/index/icon_i5.png" class="img1">联系客服<i></i>
          </li>
          <li @click="$router.push('/loan')">
            <img src="./index/index/icon_i6.png" class="img2">提现记录<i></i>
          </li>
          <li @click="$router.push('/set')">
            <img src="./index/index/icon_i7.png" class="img2">设置<i></i>
          </li>
          <li >
...
<script>
 ...
 export default {
      ...
      menuList: [
        {
          ...
          // iconActive: require('./img/icon_home_active.png'),
        }, {
          name: '我的',
          path: '/my',
  ...
  methods: {
    ...
    toggleTabs(index) {
      if (this.menuList[index].path != this.$route.path) {
